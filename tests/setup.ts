...
vi.mock('@/lib/prisma', () => ({
  prisma: {
    ...
    organizationMember: { findMany: vi.fn().mockResolvedValue([]), findUnique: vi.fn(), create: vi.fn(), deleteMany: vi.fn() },
    renewalItem: { findMany: vi.fn().mockResolvedValue([]), findFirst: vi.fn(), create: vi.fn(), update: vi.fn(), deleteMany: vi.fn() },
    integration: { findUnique: vi.fn(), findMany: vi.fn(), update: vi.fn(), deleteMany: vi.fn() },
