...
| 7. Deployment | One install/upgrade path; configured ports; failing readiness gates; correct migrations; versioned images; rollback compatibility; fresh/upgrade tests; separated destructive commands | Readiness gate corrected with failure-injection tests; full install/upgrade and other requirements pending |
